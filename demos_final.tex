...
$s\ldots \overrightarrow{xz} \ldots t\Rightarrow_{EK} d_{k}(z) = d_{k}(x)+1$ 
...
$P$ es facil, en cada fwb solo se ejecuta una vez, entonces es $O(1)$ pero se 
puede realizar $n-2$ veces en una ola, entonces:
\begin{align*}
    P &= \#\,\text{total de fwb}\\
...
$M(x)$ al inicio es vacio, pero le voy agregando vertices.
\medskip
